...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{asset('assets/admin/css/admin.styles.min.css')}}" />
				...
				<div>
					...
					<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
						<ul id="sidebarnav">
							...
							<li class="sidebar-item">
								<a class="sidebar-link" href="/dashboard/products" aria-expanded="false">
									<span>
										<img class="" src="{{asset('assets/images/icons/products.svg')}}" />
									</span>
							...
							<li class="sidebar-item">
								<a class="sidebar-link" href="/dashboard/orders" aria-expanded="false">
									<span>
							...
							<li class="sidebar-item">
								<a class="sidebar-link" href="/dashboard/customers" aria-expanded="false">
									<span>
